...
echo "=== Building MacTeX MathEditor Full Installer DMG v1.5.0 ==="
...
mkdir -p "../installers"
PKG_OUTPUT="../installers/Install_Word_Plugin_v1.5.0.pkg"
...
OUTPUT_DMG="../installers/MacTeXMathEditor_Full_Installer_v1.5.0.dmg"
rm -f "$OUTPUT_DMG"

echo "Packaging into DMG..."
hdiutil create -volname "MacTeX MathEditor Installer v1.5.0" -srcfolder "$STAGING_DIR" -ov -format UDZO "$OUTPUT_DMG"
rm -rf "$STAGING_DIR"
